...
public class LoginProfessorSessionAuthenticator {
    ...
    private static final Logger log = LoggerFactory.getLogger(LoginProfessorSessionAuthenticator.class);

    @Around("@annotation(com.sugangbk.rest.aop.annotation.PermitProfessor)")
